	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="38.86" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
...
<?php  
if ($Instagram == '"number"') {
    echo '<input type="<?= $Instagram ?>" name="Instagram" class="form-control" id="t1" placeholder="Instagram" />';
}
if ($Youtube == '"number"') {
    echo '<input type="<?= $Youtube ?>" name="Youtube" class="form-control" id="t1" placeholder="Youtube" />';
}
if ($Twitter == '"number"') {
    echo '<input type="<?= $Twitter ?>" name="Twitter" class="form-control" id="t1" placeholder="Twitter" />';
}
if ($Facebook == '"number"') {
    echo '<input type="<?= $Facebook ?>" name="Facebook" class="form-control" id="t1" placeholder="Facebook" />';
}
if ($Tiktok == '"number"') {
    echo '<input type="<?= $Tiktok ?>" name="Tiktok" class="form-control" id="t1" placeholder="Tiktok" />';
}
if ($Pinterest == '"number"') {
...
?>
                        ...
                        <a href="index_7.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
