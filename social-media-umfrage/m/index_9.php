                    ...
                    <form method="post" action="index_10.php">
                        <div class="form-check" style="">         
							...
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="customCheck1" style="">Memes</label><br />
							</div>
							<!-- 2 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck2" name="checkbox2" value="1" />
								<label class="custom-control-label" for="customCheck2" style="">Beruflich</label><br />
							</div>
							<!-- 3 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck3" name="checkbox3" value="1"/>
								<label class="custom-control-label" for="customCheck3" style="">Stars/Promimenten folgen</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="checkbox4" class="custom-control-input" id="customCheck4" value="1" />
								<label class="custom-control-label" for="customCheck4" style="">Bilder hochladen</label><br />
							</div>
							<!-- 5 -->
							<div class="custom-control custom-checkbox">
                        ...
                        <a href="index_8.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
