...
$sql = "UPDATE fragen SET index_4='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 14.286%" aria-valuenow="14.286" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
