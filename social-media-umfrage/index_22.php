...
$sql = "UPDATE fragen SET index_21='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 83.27%" aria-valuenow="83.27" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Mein Umfeld hat wenig Vertrauen in meine Versprechen</div>
                    <form method="post" action="index_23.php">
			...
			<nav>
				...
				<li>Auf keinen Fall</li>
                        ...
                        <a href="index_21.php"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
