	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 32.143%" aria-valuenow="5.55" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_11.php">
                        <div class="form-check" style="">
							...
							<div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio1" style="">ja</label><br />
							</div>
							<!-- 2 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio2" value="manchmal" />
								<label class="custom-control-label" for="customRadio2" style="">ja, manchmal</label><br />
							</div>
							<!-- 3 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio3" value="nicht" />
								<label class="custom-control-label" for="customRadio3" style="">eher nicht</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio4" value="gar_nicht" />
								<label class="custom-control-label" for="customRadio4" style="">gar nicht</label><br />
							</div>
							</div>
                        <div class="center" style="">
                        <a href="index_9.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
