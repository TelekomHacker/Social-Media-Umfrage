...
$sql = "UPDATE fragen SET index24='$check1' WHERE F_ID='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 85.714%" aria-valuenow="88.82" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Wie oft fühlst du dich müde und kraftlos?</div>
                    <form method="post" action="index_26.php">
			...
			<nav>
				<li style="margin-right: 45%">Oft</li>
				<li>Nie</li>
			</nav>
                        ...
                        <a href="index_24.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
