...
$sql = "UPDATE fragen SET index23='$check1' WHERE F_ID='$ip'";
	       ...
	       <div class="header">
			...
			<nav>
				...
				<li>Total unzufrienden</li>
                        ...
                        <a href="index_23.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
