...
$sql = "UPDATE fragen SET index_11='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 39.286%" aria-valuenow="39.286" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_13.php">
                        <div class="form-check" style="">         
							...
							<div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio1" style="margin-bottom: 4px;">Ja absolut</label><br />
							</div>
							<!-- 2 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio2" value="2" />
								<label class="custom-control-label" for="customRadio2" style="margin-bottom: 4px;">Ja, manchmal</label><br />
							</div>
							<!-- 3 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio3" value="3" />
								<label class="custom-control-label" for="customRadio3" style="margin-bottom: 4px;">Nein, eigentlich nicht</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio4" value="4" />
								<label class="custom-control-label" for="customRadio4" style="margin-bottom: 4px;">Nein, absolut nicht</label><br />
							</div>                       
							</div>
