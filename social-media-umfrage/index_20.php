...
$sql = "UPDATE fragen SET index_19='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 67.857%" aria-valuenow="67.857" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Ich führe engere Freundschften als es die meisten Leute machen</div>
                    <form method="post" action="index_21.php">
			...
			<nav>
				...
				<li>Auf keinen Fall</li>
                        ...
                        <a href="index_19.php"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
