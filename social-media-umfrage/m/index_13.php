...
$sql = "UPDATE fragen SET index12='$check1' WHERE F_ID='$ip'";
                    ...
                    <form method="post" action="index_14.php">
                        <div class="form-check" style="">  
                            ...
                            <div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio2" style="">Nein</label><br />
							</div>
							</div>                       
							</div>
                        <div class="center" style="">
                        <a href="index_12.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
