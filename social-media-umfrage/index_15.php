...
$sql = "UPDATE fragen SET index14='$check1' WHERE F_ID='$ip'";
      ...
      <div class="modal-footer">
	   ...
	   <div class="wrapper">
	       <div class="header">
			...
			<nav>
				<li style="margin-right: 45%">Alle</li>
				<li>Keine</li>
			</nav>
                        ...
                        <a href="index_14.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
