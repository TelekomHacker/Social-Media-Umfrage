...
?>                                                            
							...
							<div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio1" style="">Glücklicher</label><br />
							</div>
							<!-- 2 -->
                            <div class="custom-control custom-radio">
							
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio2" value="2" />
								<label class="custom-control-label" for="customRadio2" style="">Keine Veränderung</label><br />
							</div>
							<!-- 3 -->
							<div class="custom-control custom-radio">
							
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio3" value="3" />
								<label class="custom-control-label" for="customRadio3" style="">Unglücklicher</label><br />
							</div>
