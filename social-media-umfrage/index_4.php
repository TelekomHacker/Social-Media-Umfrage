	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 10.714%" aria-valuenow="16.65" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
					...
					<input type="hidden" name="id" value= "<?=$ip ?>">
                        ...
                        <div class="center" style="">
                            <a href="index_3.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
