                ...
                <div class="frage">
                    ...
                    <form method="post" action="index_11.php">
                        <div class="form-check" style="">         
							...
							<!-- 2 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio2" value="männlich" />
								<label class="custom-control-label" for="customRadio2" style="margin-bottom: 4px;">ja, manchmal</label><br />
							</div>
							<!-- 3 -->
                            <div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio3" value="männlich" />
								<label class="custom-control-label" for="customRadio3" style="margin-bottom: 4px;">eher nicht</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio4" value="männlich" />
								<label class="custom-control-label" for="customRadio4" style="margin-bottom: 4px;">gar nicht</label><br />
							</div>                        </div>
