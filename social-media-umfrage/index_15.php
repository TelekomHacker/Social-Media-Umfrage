...
$sql = "UPDATE fragen SET index_14='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 49.97%" aria-valuenow="49.97" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Sind deine Freunde ebenfalls auf Social Media?</div>
			...
			<nav>
				<li style="margin-right: 40%">Alle</li>
				<li>keine</li>
			</nav>
                        ...
                        <a href="index_14.php"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
