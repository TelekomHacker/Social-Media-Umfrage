	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 35.714%" aria-valuenow="35.714" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_12.php">
						...
						<div class="row">
							...
							<div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio1" style="margin-bottom: 4px;">Glücklicher</label><br />
							</div>
							<!-- 2 -->
                            <div class="custom-control custom-radio">
							
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio2" value="2" />
								<label class="custom-control-label" for="customRadio2" style="margin-bottom: 4px;">Keine Veränderung</label><br />
							</div>
							<!-- 3 -->
							<div class="custom-control custom-radio">
							
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio3" value="3" />
								<label class="custom-control-label" for="customRadio3" style="margin-bottom: 4px;">Unglücklicher</label><br />
							</div>
