...
$sql = "UPDATE fragen SET index_16='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 57.143%" aria-valuenow="57.143" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
