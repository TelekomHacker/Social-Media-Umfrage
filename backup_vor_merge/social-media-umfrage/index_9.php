...
</br>Wenn Sie eine Berichtigung, Sperrung, Löschung oder Auskunft über die zu Ihrer Person gespeicherten personenbezogenen Daten wünschen oder Fragen bzgl. der Erhebung, Verarbeitung oder Verwendung Ihrer personenbezogenen Daten haben oder erteilte Einwilligungen widerrufen möchten, wenden Sie sich bitte an folgende  <font color="red">E-Mail-Adresse: [muster@stiftkeppel.de]</font>
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 28.571%" aria-valuenow="28.571" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_10.php">
                        <div class="form-check" style="">         
							...
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="customCheck1" style="margin-bottom: 4px;">Memes</label><br />
							</div>
							<!-- 2 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck2" name="checkbox2" value="1" />
								<label class="custom-control-label" for="customCheck2" style="margin-bottom: 4px;">Beruflich</label><br />
							</div>
							<!-- 3 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck3" name="checkbox3" value="1"/>
								<label class="custom-control-label" for="customCheck3" style="margin-bottom: 4px;">Stars/Promimenten</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" name="checkbox4" class="custom-control-input" id="customCheck4" value="1" />
								<label class="custom-control-label" for="customCheck4" style="margin-bottom: 4px;">Bilder hochladen</label><br />
							</div>
							<!-- 5 -->
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="customCheck5" name="checkbox5" value="1" />
								<label class="custom-control-label" for="customCheck5" style="margin-bottom: 4px;">Lifestyle bloggern folgen</label><br />
							</div>
