	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 17.857%" aria-valuenow="17.857" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_7.php">
                        <div class="form-check" style="">         
                            ...
                            <label class="custom-control-label" for="customCheck1" style="margin-bottom: 4px;">WhatsApp</label>
							</div>
							<!-- 2 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck2" name="checkbox2" value="1" />
                            <label class="custom-control-label" for="customCheck2" style="margin-bottom: 4px;">Snapchat</label>
							</div>
							<!-- 3 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck3" name="checkbox3" value="1"/>
                            <label class="custom-control-label" for="customCheck3" style="margin-bottom: 4px;">Telegram</label>
							</div>
							<!-- 4 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" name="checkbox4" class="custom-control-input" id="customCheck4" value="1" />
                            <label class="custom-control-label" for="customCheck4" style="margin-bottom: 4px;">Threema</label>
							</div>
							<!-- 5 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck5" name="checkbox5" value="1" />
                            <label class="custom-control-label" for="customCheck5" style="margin-bottom: 4px;">FB Messenger</label>
							</div>
                        </div>
