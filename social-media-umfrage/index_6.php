	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 17.857%" aria-valuenow="27.76" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_7.php">
                        <div class="form-check" style="">
                            ...
                            <label class="custom-control-label" for="customCheck1" style="">WhatsApp</label><br />
                            </div>
							<!-- 2 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck2" name="checkbox2" value="1" />
                            <label class="custom-control-label" for="customCheck2" style="">Snapchat</label><br />
                            </div>
							<!-- 3 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck3" name="checkbox3" value="1"/>
                            <label class="custom-control-label" for="customCheck3" style="">Telegram</label><br />
                            </div>
							<!-- 4 -->
							<div class="custom-control custom-checkbox">
                            <input type="checkbox" name="checkbox4" class="custom-control-input" id="customCheck4" value="1" />
                            <label class="custom-control-label" for="customCheck4" style="">Threema</label><br />
                            </div>
							<!-- 5 -->
							<div class="custom-control custom-checkbox">
                        ...
                        <a href="index_5.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
