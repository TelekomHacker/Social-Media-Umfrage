...
$sql = "UPDATE fragen SET index_20='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 71.429%" aria-valuenow="71.429" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Wenn ich gerne einen Tagesausflug machen möchte finde ich schnell Begleiter</div>
			...
			<nav>
				...
				<li>Auf keinen Fall</li>
                        ...
                        <a href="index_22.php"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
