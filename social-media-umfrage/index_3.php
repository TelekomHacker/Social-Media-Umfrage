...
$sql = "UPDATE fragen SET index_2='$check1' WHERE id='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 7.143%" aria-valuenow="7.143" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
