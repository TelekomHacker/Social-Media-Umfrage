...
$sql = "UPDATE fragen SET index25='$check1' WHERE F_ID='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 89.286%" aria-valuenow="94.38" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
			...
			<nav>
				...
				<li>Nie</li>
                        ...
                        <a href="index_25.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
