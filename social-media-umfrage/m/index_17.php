...
$sql = "UPDATE fragen SET index16='$check1' WHERE F_ID='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 57.143%" aria-valuenow="55,52" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
			...
			<nav>
				...
				<li>Auf keinen Fall</li>
                        ...
                        <a href="index_16.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
