...
$sql = "UPDATE fragen SET index20='$check1' WHERE F_ID='$ip'";
	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 71.429%" aria-valuenow="77.72" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    <div class="h2" style="">Wenn ich gerne einen Tagesausflug machen möchte finde ich schnell Begleiter</div>
                    <form method="post" action="index_22.php">
			...
			<nav>
				<li style="margin-right: 30%">Auf jeden Fall</li>
				<li>Auf keinen Fall</li>
                        ...
                        <a href="index_20.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
