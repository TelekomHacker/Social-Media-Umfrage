                    ...
                    <form method="post" action="index_13.php">
						...
						<input type="hidden" name="id" value= "<?=$ip ?>">
                            ...
                            <div class="custom-control custom-radio">
								...
								<label class="custom-control-label" for="customRadio3" style="">Nein, eigentlich nicht</label><br />
							</div>
							<!-- 4 -->
							<div class="custom-control custom-radio">
								<input type="radio" name="radiobox" class="custom-control-input" id="customRadio4" value="4" />
								<label class="custom-control-label" for="customRadio4" style="">Nein, absolut nicht</label><br />
							</div>                       
							</div>
                        <div class="center" style="">
                        <a href="index_11.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
