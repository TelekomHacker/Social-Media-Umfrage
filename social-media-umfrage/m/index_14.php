	   ...
	   <div class="wrapper">
	       <div class="header">
	            ...
	            <div class="progress" style="">
                    <div class="progress-bar" role="progressbar" style="width: 44.42%" aria-valuenow="46.429%" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="frage">
                    ...
                    <form method="post" action="index_15.php">
                        <div class="form-check" style="">         
                            ...
                            <input type="radio" name="radiobox" class="custom-control-input" id="customRadio1" value="schwarz" />
                            <label class="custom-control-label" for="customRadio1" style="color: #000000">Schwarz</label><br />
                            </div>
							<!-- 2 -->
							<div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="customRadio2" name="radiobox" value="gr&uuml;n" />
                            <label class="custom-control-label" for="customRadio2" style="color:	#006600 ">Gr&uuml;n</label><br />
                            </div>
							<!-- 3 -->
							<div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="customRadio3" name="radiobox" value="rot"/>
                            <label class="custom-control-label" for="customRadio3" style="color: #ff0000">Rot</label><br />
                            </div>
							<!-- 4 -->
							<div class="custom-control custom-radio">
                            <input type="radio" name="radiobox" class="custom-control-input" id="customRadio4" value="weiß" />
                            <label class="custom-control-label" for="customRadio4" style="color: #ccccb3">Weiß</label><br />
                            </div>
							<!-- 5 -->
							<div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="customRadio5" name="radiobox" value="blau" />
                            <label class="custom-control-label" for="customRadio5" style="color: #0000ff">Blau</label><br />
                            </div>
							<!-- 6 -->
							<div class="custom-control custom-radio">
                            <input type="radio" name="radiobox" class="custom-control-input" id="customRadio6" value="rosa" />
                            <label class="custom-control-label" for="customRadio6" style="color: #FF69B4">Rosa</label><br />
                            </div>
							<!-- 7 -->
							<div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="customRadio7" name="radiobox" value="gelb" />
                            <label class="custom-control-label" for="customRadio7" style="color:   #ffbf00">Gelb</label><br />
                            </div>
							<!-- 8 -->
							<div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="customRadio8" name="radiobox" value="gelb"/>
                            <label class="custom-control-label" for="customRadio8" style=": #9900cc">Violett</label><br />
                            </div>
							<!-- 9 -->
							<div class="custom-control custom-radio">
                            <input type="radio" name="radiobox" class="custom-control-input" id="customRadio9" value="andere" />
                            <label class="custom-control-label" for="customRadio9" style="">Andere</label><br />
                            </div>
                        </div>
                        <div class="center" style="">
                        <a href="index_13.php?back=2&backid=<?php echo $ip; ?>"><button type="button" class="btn btn-outline-secondary" style="" >Zur&uuml;ck</button></a>
